...
void OBJMesh::drawChunk(int chunkIndex) 
{
	//binds vertex and index buffers
	glBindVertexArray(m_meshChunks[chunkIndex].vao);

	//draw mesh chunk(s)
	glDrawElements(GL_TRIANGLES, m_meshChunks[chunkIndex].indexCount, GL_UNSIGNED_INT, 0);
}
